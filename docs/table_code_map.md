...
| Appendix additional value tables | `paper_outputs/tables/table_appendix_additional_values.tex` | `python scripts/build_tables.py` | `artifacts/results/fireprone_contract_progression_summary.raw.json` |

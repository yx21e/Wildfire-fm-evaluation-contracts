...
The rendered preview in Figure~\ref{fig:example_heatmap} uses the nonzero 99.5th percentile, 0.2023, as its upper color cap and gamma 0.45 for readability.

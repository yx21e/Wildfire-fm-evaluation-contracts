...
\begin{figure}[t]
\centering
\includegraphics[width=0.92\linewidth]{figures/firewxfm_conus_20260706_t12_heatmap.png}
\caption{Example \model{} active-fire occupancy heatmap generated from 2026-07-06 12:00 UTC HRRR input, with a 12-hour lead to 2026-07-07 00:00 UTC. Brighter colors indicate higher predicted active-fire occupancy probability. The rendered image is percentile-scaled for visualization; quantitative analysis should use the probability raster.}
...
Inside the Lower-48 mask, the mean probability is 0.0579.
The maximum probability in the masked raster is 0.9370.
The 99th and 99.9th percentiles of the masked raster are 0.4134 and 0.7550.
These values describe one input time map and should not be interpreted as climatological frequencies.
The rendered preview in Figure~\ref{fig:example_heatmap} uses the nonzero 99.5th percentile, 0.6217, as its upper color cap and gamma 0.45 for readability.
This display transform makes low-probability regions visible; it does not change the probability raster.
...
Rendered heatmap & Provides a percentile-scaled visual preview of the same probability output. \\
